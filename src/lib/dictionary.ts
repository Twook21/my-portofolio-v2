export const dictionary = {
  en: {
    ...
    ui: {
      ...
      storyDesc: "Not a traditional path. A deliberate one. Every project, every internship, every late-night debugging session — all pointing toward a singular goal: engineering software that matters, at the highest level.",
  ...
  id: {
    ...
    ui: {
      ...
      storyDesc: "Bukan jalan tradisional. Tapi disengaja. Setiap proyek, setiap magang, setiap sesi debugging larut malam — semua mengarah pada satu tujuan: membangun perangkat lunak yang penting, di level tertinggi.",
